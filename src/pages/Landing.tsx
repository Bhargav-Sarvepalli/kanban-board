...
function FlowSVG() {
  return (
    <svg viewBox="0 0 860 340" role="img" aria-label="NexTask Flow diagram showing feature branches without overlap" style={{ width: '100%', display: 'block' }}>
      <defs>
        <linearGradient id="landingFlowTrunk" x1="54" y1="170" x2="806" y2="170" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#2dd4bf" />
          <stop offset="48%" stopColor="#8b5cf6" />
          <stop offset="100%" stopColor="#64748b" />
        </linearGradient>
        <filter id="landingFlowGlow" x="-80%" y="-80%" width="260%" height="260%">
          <feGaussianBlur stdDeviation="4" result="blur" />
          <feMerge><feMergeNode in="blur" /><feMergeNode in="SourceGraphic" /></feMerge>
        </filter>
      </defs>

      <rect x={18} y={16} width={824} height={306} rx={18} fill="rgba(255,255,255,0.018)" stroke="rgba(255,255,255,0.055)" />

      <line x1={54} y1={170} x2={806} y2={170} stroke="rgba(255,255,255,0.09)" strokeWidth={22} strokeLinecap="round" />
      <line x1={54} y1={170} x2={806} y2={170} stroke="url(#landingFlowTrunk)" strokeWidth={5} strokeLinecap="round" />
      <line x1={650} y1={170} x2={806} y2={170} stroke="rgba(255,255,255,0.24)" strokeWidth={5} strokeLinecap="round" strokeDasharray="12 14" />

      <path d="M 118 170 C 136 170 134 68 170 68" fill="none" stroke="#22c55e" strokeWidth={2.4} strokeLinecap="round" opacity={0.72} />
      <path d="M 350 68 C 386 68 368 170 392 170" fill="none" stroke="#22c55e" strokeWidth={2.4} strokeLinecap="round" opacity={0.62} />
      <path d="M 146 170 C 164 170 164 274 170 274" fill="none" stroke="#22c55e" strokeWidth={2.4} strokeLinecap="round" opacity={0.72} />
      <path d="M 350 274 C 386 274 368 170 392 170" fill="none" stroke="#22c55e" strokeWidth={2.4} strokeLinecap="round" opacity={0.62} />

      <path d="M 444 170 C 464 170 470 70 510 70" fill="none" stroke="#8b5cf6" strokeWidth={2.3} strokeLinecap="round" opacity={0.68} />
      <path d="M 472 170 C 492 170 502 272 536 272" fill="none" stroke="#06b6d4" strokeWidth={2.3} strokeLinecap="round" opacity={0.62} />
      <path d="M 672 170 C 702 170 696 70 728 70" fill="none" stroke="#64748b" strokeWidth={2} strokeLinecap="round" strokeDasharray="7 9" opacity={0.44} />

      {[118,146,392].map((x, i) => <circle key={`done-dot-${i}`} cx={x} cy={170} r={5.5} fill="#22c55e" />)}
      {[444,472].map((x, i) => <circle key={`active-dot-${i}`} cx={x} cy={170} r={5.5} fill={i === 0 ? '#8b5cf6' : '#06b6d4'} />)}
      <circle cx={672} cy={170} r={5.5} fill="#64748b" />

      <g fontFamily="Inter, system-ui, sans-serif">
        <rect x={170} y={38} width={180} height={60} rx={12} fill="rgba(34,197,94,0.11)" stroke="rgba(34,197,94,0.46)" />
        <circle cx={196} cy={68} r={12} fill="#22c55e" filter="url(#landingFlowGlow)" />
        <text x={218} y={64} fill="rgba(255,255,255,0.9)" fontSize={13} fontWeight={780}>Auth and login</text>
        <text x={218} y={82} fill="#86efac" fontSize={10} fontWeight={840}>MERGED 100%</text>

        <rect x={170} y={244} width={180} height={60} rx={12} fill="rgba(34,197,94,0.11)" stroke="rgba(34,197,94,0.46)" />
        <circle cx={196} cy={274} r={12} fill="#22c55e" filter="url(#landingFlowGlow)" />
        <text x={218} y={270} fill="rgba(255,255,255,0.9)" fontSize={13} fontWeight={780}>Kanban core</text>
        <text x={218} y={288} fill="#86efac" fontSize={10} fontWeight={840}>MERGED 100%</text>

        <rect x={510} y={40} width={180} height={60} rx={12} fill="rgba(139,92,246,0.13)" stroke="rgba(139,92,246,0.46)" />
        <circle cx={536} cy={70} r={12} fill="#8b5cf6" filter="url(#landingFlowGlow)" />
        <text x={558} y={66} fill="rgba(255,255,255,0.9)" fontSize={13} fontWeight={780}>Flow engine</text>
        <rect x={558} y={78} width={86} height={3} rx={1.5} fill="rgba(255,255,255,0.12)" />
        <rect x={558} y={78} width={58} height={3} rx={1.5} fill="#a78bfa" />
        <text x={678} y={83} textAnchor="end" fill="#c4b5fd" fontSize={10} fontWeight={820}>68%</text>

        <rect x={536} y={242} width={180} height={60} rx={12} fill="rgba(6,182,212,0.1)" stroke="rgba(6,182,212,0.4)" />
        <circle cx={562} cy={272} r={12} fill="#06b6d4" filter="url(#landingFlowGlow)" />
        <text x={584} y={268} fill="rgba(255,255,255,0.9)" fontSize={13} fontWeight={780}>Standup brief</text>
        <rect x={584} y={280} width={86} height={3} rx={1.5} fill="rgba(255,255,255,0.12)" />
        <rect x={584} y={280} width={37} height={3} rx={1.5} fill="#22d3ee" />
        <text x={704} y={285} textAnchor="end" fill="#67e8f9" fontSize={10} fontWeight={820}>43%</text>

        <rect x={728} y={40} width={88} height={60} rx={12} fill="rgba(100,116,139,0.08)" stroke="rgba(148,163,184,0.2)" />
        <circle cx={754} cy={70} r={10} fill="#0b1020" stroke="rgba(255,255,255,0.22)" />
        <text x={774} y={68} fill="rgba(255,255,255,0.5)" fontSize={12} fontWeight={720}>Calendar</text>
        <text x={774} y={84} fill="rgba(255,255,255,0.28)" fontSize={9} fontWeight={760}>Planned</text>
      </g>

      <g fontFamily="Inter, system-ui, sans-serif">
        <circle cx={76} cy={170} r={19} fill="#07130d" stroke="#22c55e" strokeWidth={2.2} />
        <circle cx={76} cy={170} r={8} fill="#22c55e" />
        <text x={76} y={207} textAnchor="middle" fill="#86efac" fontSize={11} fontWeight={850}>Kickoff</text>

        <circle cx={420} cy={170} r={26} fill="#20133d" stroke="#a78bfa" strokeWidth={2.2} filter="url(#landingFlowGlow)" />
        <circle cx={420} cy={170} r={8} fill="#a78bfa" />
        <text x={420} y={211} textAnchor="middle" fill="#ddd6fe" fontSize={11} fontWeight={850}>Designing</text>

        <circle cx={650} cy={170} r={17} fill="#090b12" stroke="rgba(255,255,255,0.24)" strokeWidth={1.7} />
        <circle cx={650} cy={170} r={4} fill="rgba(255,255,255,0.26)" />
        <text x={650} y={207} textAnchor="middle" fill="rgba(255,255,255,0.36)" fontSize={10} fontWeight={760}>Build</text>

        <circle cx={790} cy={170} r={14} fill="#090b12" stroke="rgba(255,255,255,0.16)" strokeWidth={1.5} />
        <circle cx={790} cy={170} r={3} fill="rgba(255,255,255,0.18)" />
        <text x={790} y={203} textAnchor="middle" fill="rgba(255,255,255,0.25)" fontSize={9} fontWeight={760}>Launch</text>
      </g>
    </svg>
  )
}
