    ...
    <div style={{ position: 'fixed', inset: 0, zIndex: 11000, background: 'rgba(0,0,0,0.7)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
      ...
      <div style={{ background: '#111118', border: '1px solid #1e1e2e', borderRadius: '12px', padding: '24px', width: '380px', boxShadow: '0 24px 60px rgba(0,0,0,0.8)' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
          <h3 style={{ color: '#e2e2e8', fontSize: '15px', fontFamily: 'Inter, sans-serif', fontWeight: 600, margin: 0 }}>Add Team Member</h3>
        ...
        {success ? (
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px', padding: '20px 0' }}>
            <div style={{ width: '36px', height: '36px', borderRadius: '50%', background: 'rgba(22,163,74,0.15)', border: '1px solid rgba(22,163,74,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '18px' }}>✓</div>
            <p style={{ color: '#e2e2e8', fontSize: '14px', fontFamily: 'Inter, sans-serif', margin: 0 }}>Member added</p>
          </div>
        ) : (
          <>
            ...
            {/* Role explanation */}
            <p style={{ color: '#3d3d52', fontSize: '11px', fontFamily: 'Inter, sans-serif', margin: '0 0 16px', lineHeight: 1.5 }}>
              {role === 'manager'
                ? 'Can edit project details, add members, manage features and milestones.'
                : 'Can view and update tasks. Cannot edit project settings.'}
            </p>
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
              ...
              <button onClick={handleInvite} disabled={saving || !email.trim()} style={primaryBtnStyle(!!email.trim() && !saving)}>
